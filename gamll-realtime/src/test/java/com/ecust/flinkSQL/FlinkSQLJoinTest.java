...
import com.ecust.bean.WaterSensor;
...
public class FlinkSQLJoinTest {
    public static void main(String[] args) throws Exception {
        ...
        // 构建事实表
//        SingleOutputStreamOperator<WaterSensor> waterSensorDS = env.socketTextStream("hostname102", 8888)
//                .map(line -> {
//                    String[] split = line.split(",");
//                    return new WaterSensor(split[0], Double.parseDouble(split[1]), Long.parseLong(split[2]));
//                });

        SingleOutputStreamOperator<WaterSensor> waterSensorDS  = env.fromElements(
                new WaterSensor("1001",90.0d,10)
        );
